    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            ...
                            <span class="subheading">Vous avez une demande ? Dites nous...</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Voulez-vous qu'on écrive vos histoires ? Faites votre demande !</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback" data-sb-feedback="name:required">Nom / Prénom requis.</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" id="email" type="email" placeholder="Enter your email..." data-sb-validations="required,email" />
                                    <label for="email">Adresse Mail</label>
                                    <div class="invalid-feedback" data-sb-feedback="email:required">Adresse mail requise.</div>
                                    <div class="invalid-feedback" data-sb-feedback="email:email">Adresse mail non conforme.</div>
                                </div>
                                <div class="form-floating">
